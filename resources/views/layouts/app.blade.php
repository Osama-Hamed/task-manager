            ...
            <div class="container mx-auto">
                <div class="flex justify-between items-center py-2">
                    <a class="navbar-brand" href="{{ url('/projects') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="291" height="45" viewbox="0 0 291 45" class="relative text-default" style="top: 2px;">
                            <g fill="none" fill-rule="evenodd">
                                <g class="fill-current">
                                    ...
                                    <text font-family="Helvetica" font-size="12" transform="translate(51 14)">
                                        <tspan x="123.117" y="14">feathery reminders</tspan>
                                    </text>
                                </g>
                                <path stroke="#222" stroke-opacity=".218" stroke-width=".5" d="M12.454 37L9 39.784l6.598.852L12.299 43 26 40.636"></path>
                        ...
                        <div class="flex items-center ml-auto">
                            ...
                            <dropdown align="right" width="200px">
                                <template v-slot:trigger>
                                    <button
                                        class="flex items-center text-default no-underline text-sm font-bold focus:outline-none"
                                        v-pre
                                    >
                                        <img width="35"
