...
class ManageProjectsTest extends TestCase
{
    ...
    /** @test */
    public function an_authenticated_user_cannot_view_the_projects_of_the_others()
    {
        $this->signIn();
    ...
    /** @test */
    public function an_authenticated_user_cannot_update_the_projects_of_the_others()
    {
        $this->signIn();
